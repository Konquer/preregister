const config = {
    ...
    // Only allow for a single preregistration per IP address
    ip_restricted: true,
    ...
    mail_templates: {
        ...
        verification_sent: {
            from: "Example preregister <preregister@example.com>",
    ...
    outputs: {
        errors: {
            ...
            ip_used: "We only allow for one preregistration per IP.",
